...
2/0
mean=ds.resample({'time':'MS'}).mean()
maxi=ds.resample({'time':'MS'}).max()

mean.to_netcdf('mercatorglorys12v1.so.mean.{}{}.da.ab.nc'.format(yyyy,mm),format="NETCDF3_64BIT")
maxi.to_netcdf('mercatorglorys12v1.so.max.{}{}.da.ab.nc'.format(yyyy,mm),format="NETCDF3_64BIT")
